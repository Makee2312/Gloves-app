    ...
    dippingProcess: {
      compoundPrep: {
        ...
        monitoredData: [
          ...
          { "parameterName": "Compounding Duration", "value": 60, "metric": "minutes" } 

        ],
        calculatedParameters: [
          { parameterName: "Final Compound pH", value: 10.8, metric: "pH", status: "Pass" },
        ],
      },
      "formerPrep": { 
        ...
        "monitoredData": [ 
          ...
          { "parameterName": "Former Cleaning Log", "value": "Confirmed wash cycle", "metric": "text" }, 
  
          { "parameterName": "Coagulant Concentration", "value": 20, "metric": "%wt" }, 
      ...
      "latexDipping": { 
        ...
        "monitoredData": [ 
          ...
          { "parameterName": "Viscosity Sensor Reading", "value": 1200, "metric": "cP" } 
    ...
    postDipping: {
      "leaching": { 
        ...
        "monitoredData": [ 
          ...
          { "parameterName": "Leach Bath 1 Temperature", "value": 70, "metric": "°C" }, 
  
          { "parameterName": "Leach Bath 1 Duration", "value": 3, "metric": "minutes" }, 
  
          { "parameterName": "Leach Bath 2 Temperature", "value": 80, "metric": "°C" }, 
  
          { "parameterName": "Leach Bath 2 Duration", "value": 5, "metric": "minutes" } 
  ...
  },
   {
    ...
    // Fully completed & passed
    {
      ...
      dippingProcess: {
        compoundPrep: {
          ...
          monitoredData: [
            ...
            { parameterName: "Compounding Duration", value: 62, metric: "minutes" }
          ],
          calculatedParameters: [
            { parameterName: "Final Compound pH", value: 10.7, metric: "pH", status: "Pass" },
          ],
        },
        formerPrep: {
          monitoredData: [
            { parameterName: "Former Cleaning Log", value: "Confirmed wash cycle", metric: "text" },
            { parameterName: "Coagulant Concentration", value: 21, metric: "%wt" },
        ...
        latexDipping: {
          monitoredData: [
            ...
            { parameterName: "Viscosity Sensor Reading", value: 1190, metric: "cP" }
          ]
        }
      },
      postDipping: {
        leaching: {
          monitoredData: [
            { parameterName: "Leach Bath 1 Temperature", value: 72, metric: "°C" },
            { parameterName: "Leach Bath 1 Duration", value: 4, metric: "minutes" },
            { parameterName: "Leach Bath 2 Temperature", value: 82, metric: "°C" },
            { parameterName: "Leach Bath 2 Duration", value: 6, metric: "minutes" }
          ]
        },
        curing: {
          monitoredData: [
      ...
      qualityControlResults: {
        ...
        calculatedParameters: [
          { parameterName: "AQL Watertight Result", value: "Accepted", metric: "", status: "Pass" },
          { parameterName: "Extractable Protein Level", value: 45, metric: "μg/g", status: "Pass" },
        ],
      },
      progress: [
        { step: 1, name: "Compound Preparation", status: "Completed" },
    ...
    // Partially completed at stage 3, pass
    {
      ...
      dippingProcess: {
        compoundPrep: {
          ...
          calculatedParameters: [
            { parameterName: "Final Compound pH", value: 10.9, metric: "pH", status: "Pass" },
          ],
        },
        formerPrep: {
          monitoredData: [
      ...
      postDipping: {
        leaching: {
          monitoredData: [
            { parameterName: "Leach Bath 1 Temperature", value: 75, metric: "°C" },
          ]
        },
      ...
      qualityControlResults: {
        ...
        calculatedParameters: [
          { parameterName: "Extractable Protein Level", value: 48, metric: "μg/g", status: "Pass" },
        ],
      },
      progress: [
        { step: 1, name: "Compound Preparation", status: "Completed" },
    ...
    // Partially completed at stage 3, pass
    {
      ...
      dippingProcess: {
        compoundPrep: {
          ...
          calculatedParameters: [
            { parameterName: "Final Compound pH", value: 10.6, metric: "pH", status: "Pass" },
          ],
        },
        formerPrep: {
          monitoredData: [
      ...
      postDipping: {
        leaching: {
          monitoredData: [
            { parameterName: "Leach Bath 1 Temperature", value: 73, metric: "°C" },
          ]
        },
        curing: { monitoredData: [] },
        finishing: { monitoredData: [] }
    ...
    // Fully completed but fail in some QC
    {
      ...
      dippingProcess: {
        compoundPrep: {
          ...
          calculatedParameters: [
            { parameterName: "Final Compound pH", value: 10.5, metric: "pH", status: "Pass" },
          ],
        },
        formerPrep: {
          monitoredData: [
      ...
      postDipping: {
        leaching: {
          monitoredData: [
            { parameterName: "Leach Bath 1 Temperature", value: 76, metric: "°C" },
          ]
        },
        curing: { monitoredData: [] },
        finishing: { monitoredData: [] }
      ...
      qualityControlResults: {
        ...
        calculatedParameters: [
          { parameterName: "AQL Watertight Result", value: "Rejected", metric: "", status: "Fail" },
          { parameterName: "Extractable Protein Level", value: 55, metric: "μg/g", status: "Fail" },
        ],
      },
      progress: [
        { step: 1, name: "Compound Preparation", status: "Completed" },
...
export default function BatchProgress() {
  ...
  return (
    <div className="min-h-screen bg-gray-50 flex flex-col items-center pt-8 px-2 md:px-0">
      ...
      {/* <div className="w-full max-w-full md:max-w-full bg-white rounded-xl shadow-lg p-4 space-y-6"> */}
        ...
        <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-3">
          <div>
            ...
            <p className="text-xs text-gray-500">
              Glove Batch: <span className="font-semibold">{batch.batchLabel}</span>
            </p>
          </div>
          <div className="flex items-center gap-2">
            <label className="text-sm font-medium text-gray-700" htmlFor="batchSelect">Batch:</label>
            <select
              id="batchSelect"
            ...
            >
              {batches.map((b, idx) => (
                <option key={b.gloveBatchId} value={idx}>{b.batchLabel}</option>
              ))}
            </select>
          </div>
        </div>
        ...
        <div className="flex flex-col md:grid md:grid-cols-2 gap-4">
          <ProcessCard
            ...
            onView={() => setDrawerData({ title: "Compound Preparation", data: batch.dippingProcess.compoundPrep })}
            step={1}
          />
          <ProcessCard
            ...
            onView={() => setDrawerData({ title: "Dipping Process", data: batch.dippingProcess.latexDipping })}
            step={2}
          />
          <ProcessCard
            title="Post-Dipping"
            ...
            onView={() => setDrawerData({ title: "Post-Dipping", data: batch.postDipping.leaching })}
            step={3}
          />
          <ProcessCard
            ...
            onView={() => setDrawerData({ title: "Quality Control", data: batch.qualityControlResults })}
            step={4}
          />
        </div>
      </div>
      ...
      {/* Drawer */}
      <Drawer open={!!drawerData} onClose={() => setDrawerData(null)} title={drawerData?.title} data={drawerData?.data} />
    </div>
  );
}
    ...
    <div className="flex justify-between items-center w-full gap-2 mb-4">
      {progress.map((step, idx) => (
        <div key={step.step} className="flex flex-col items-center flex-1">
          ...
          <span className={`text-xs md:text-sm mt-2 text-center ${step.status === "Completed"
            ? "text-green-600"
            : step.status === "In Progress"
              ? "text-yellow-600"
              : "text-gray-500"
...
function ProcessCard({ title, status, data, onView, step }) {
  ...
  return (
    <div className={`rounded-lg border-2 ${statusColor} p-4 flex flex-col justify-between shadow-sm`}>
      ...
      <div className="mt-2 grid grid-cols-1 gap-1 text-sm">
        {data?.monitoredData?.slice(0, 2).map((item, i) => (
          <div key={i} className="flex justify-between">
            ...
            <span className="font-semibold">{item.value} {item.metric}</span>
          </div>
        ))}
            ...
            <div className="mt-4 space-y-2 text-sm">
              {(data.monitoredData || data.labTestData || []).map((item, i) =>
                <div key={i} className="flex justify-between border-b py-1 text-gray-700">
                  ...
                  <span className="font-semibold">{item.value ? `${item.value} ${item.metric || ""}` : ""}</span>
                </div>
              )}
              {data.calculatedParameters?.map((item, i) =>
                <div key={i} className="flex justify-between border-b py-1 text-gray-700">
                  ...
                  <span className="font-semibold">{item.value} {item.metric}</span>
                  <span className={`ml-2 text-xs ${item.status === "Pass" ? "text-green-600" : "text-red-600"}`}>{item.status}</span>
                </div>
              )}
            </div>
          </>
